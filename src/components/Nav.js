      ...
      <div ref={navRef} className="bg-navy flex-shrink-0">
        ...
        <nav className="flex items-center px-4 md:px-6 h-14 gap-3">
          ...
          <div className="flex items-center gap-2.5 flex-shrink-0">
            ...
            <span className="font-display font-bold text-white tracking-tight text-base hidden sm:inline">Snowscape</span>
          </div>

          {/* Desktop-only divider */}
          <div className="hidden md:block w-px h-5 bg-white/15 flex-shrink-0" />

          {/* Search — always in the nav bar, flex-1 on mobile, fixed width on desktop */}
          ...
          {/* Mobile-only: theme + avatar + hamburger */}
        ...
        {/* Mobile menu — page links + actions only, no search */}
        {mobileMenuOpen && (
